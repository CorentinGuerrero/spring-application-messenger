...
class DefaultBusesTest {
    ...
    static final class CapturingTransport implements MessageTransport {
        ...
        @Override
        public Object dispatch(io.github.applicationmessenger.messenger.envelope.MessageEnvelope envelope, MessageRoute route, io.github.applicationmessenger.messenger.handler.MessageHandler next) {
            this.route = route;
            return result;
        }
    }
