...
import io.github.corentinguerrero.messenger.exception.EventHandlingException;
...
class DefaultBusesTest {
    ...
    static final class CapturingTransport implements MessageTransport {
        ...
        @Override
        public Object dispatch(io.github.corentinguerrero.messenger.envelope.MessageEnvelope envelope, MessageRoute route, io.github.corentinguerrero.messenger.handler.MessageHandler next) {
            this.route = route;
            return result;
        }
    }
